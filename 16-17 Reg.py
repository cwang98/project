...
if __name__ == '__main__':
    ...
    writeinTxtFile = open("/Users/ssui9307/Desktop/1617-Reg.txt", 'a')

    url_nba = 'http://stats.nba.com/players/traditional/?DateTo=11%2F15%2F2017&sort=PTS&dir=-1&Season=2016-17&SeasonType=Regular%20Season'
    ...
    nbaWebStats.select_dropdown_option(selectAllXpath, selectText, 3)

    playerCount = nbaWebStats.get_child_elements_number(playerList_totaltbodyXpath, 0)
    print(playerCount)
    ...
    while i < playerCount:
        ...
        while n < statsColCount4EachPlayer:
            ...
            n += 1
            print('Number ' + '(' + str(i + 1) + '/' + str(playerCount) + ')' + ' player data is being written into file. (' + str(n) + '/' + str(
