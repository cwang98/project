...
##User needs to download chromedriver in order to run this file
class SimulateWebOperation():
    path = "/Users/ssui9307/Desktop/chromedriver" ##User needs to change to his own directory
    driver = webdriver.Chrome("/Users/ssui9307/Desktop/chromedriver") ##this needs to be same as above
...
if __name__ == '__main__':
    ...
    writeinTxtFile = open("/Users/ssui9307/Desktop/1718-AllGames-Reg-Advanced-FF.txt", 'a') ##path to write file

    url_nba = 'https://stats.nba.com/teams/boxscores-four-factors/?Season=2017-18&SeasonType=Regular%20Season'
    ...
    nbaWebStats.select_dropdown_option(selectAllXpath, selectText, 5)

    gameCount = nbaWebStats.get_child_elements_number(teamList_totaltbodyXpath, 0)
    print(gameCount)
